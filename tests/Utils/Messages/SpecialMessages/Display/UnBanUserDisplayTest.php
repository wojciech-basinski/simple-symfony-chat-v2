...
class UnBanUserDisplayTest extends TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->unBanUserDisplay = new UnBanUserDisplay($this->translator, $this->config);
    }
    ...
    public function testDisplay(): void
    {
        ...
        $this->assertEquals(
            ...
            $this->unBanUserDisplay->display(['text', 'user'])
        );
    }
}
